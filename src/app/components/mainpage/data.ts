...
export const emp_details: emp[]=[
    ...
    },
    {
        id:'3',
        name: 'Linda May',
        designation:'Chief Bussiness Officer',
        team: 2,
        manager: ['Mark Hill'],
